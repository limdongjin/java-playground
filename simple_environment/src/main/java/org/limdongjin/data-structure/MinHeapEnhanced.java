...
public class MinHeapEnhanced<E> {
    private List<E> heap;
    private int NumOfElement;
    private Comparator<? super E> comparator;
    
    public MinHeapEnhanced(){ 
        initMinHeap();
        comparator = null;
    }

    public MinHeapEnhanced(final Comparator<? super E> comparator) {
        this();
        this.comparator = comparator;
    }

    public MinHeapEnhanced(final Collection<? extends E> items){
        initMinHeap(items);
        this.comparator = null;
    }
    public MinHeapEnhanced(final Collection<? extends E> items, final Comparator<? super E> comparator){
        initMinHeap(items);
        this.comparator = comparator;
    }
